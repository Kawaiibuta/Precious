class EndPoint {
  ...
  static String productWithParam(
          {int start = 1, int quantity = -1, int type = -1, int? categoryId}) =>
      "${baseUrl}api/product?start=$start&quantity=$quantity${type != -1 ? "&type=$type" : ""}${categoryId != -1 && categoryId != null ? "&categoryId=$categoryId" : ""}";
