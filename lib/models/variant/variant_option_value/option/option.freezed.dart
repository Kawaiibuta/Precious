...
class _$OptionImpl with DiagnosticableTreeMixin implements _Option {
  _$OptionImpl(
      ...
      this.name,
      final List<OptionValue> values = const <OptionValue>[]})
      : _values = values;
  ...
  @override
  final String? name;
  final List<OptionValue> _values;
  @override
  @JsonKey()
  ...
  String toString({DiagnosticLevel minLevel = DiagnosticLevel.info}) {
    return 'Option(id: $id, productId: $productId, name: $name, values: $values)';
  }
  ...
  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, id, productId, name,
