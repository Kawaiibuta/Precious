...
abstract class $OptionValueCopyWith<$Res> {
  ...
  @useResult
  $Res call({@JsonKey(includeToJson: false) int? id, String value});
}
...
/// @nodoc
@JsonSerializable()
class _$OptionValueImpl implements _OptionValue {
  _$OptionValueImpl(
      {@JsonKey(includeToJson: false) this.id, required this.value});
...
abstract class _OptionValue implements OptionValue {
  factory _OptionValue(
      ...
      required final String value}) = _$OptionValueImpl;
